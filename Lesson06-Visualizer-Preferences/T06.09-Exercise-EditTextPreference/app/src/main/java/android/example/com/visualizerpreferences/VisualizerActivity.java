...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        float minSize = Float.parseFloat(sharedPreferences.getString(getString(R.string.edit_text_preference_key),
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            loadColorFromPreferences(sharedPreferences);
        } else if (key.equals(getString(R.string.edit_text_preference_key))) {
            float minSize = Float.parseFloat(sharedPreferences.getString(getString(R.string.edit_text_preference_key), "1.0"));
            mVisualizerView.setMinSizeScale(minSize);
        }
    }
