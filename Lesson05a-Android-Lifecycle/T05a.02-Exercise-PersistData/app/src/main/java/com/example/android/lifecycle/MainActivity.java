...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLABLE_TEXT_KEY = "callback";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(LIFECYCLE_CALLABLE_TEXT_KEY)){
            mLifecycleDisplay.setText(savedInstanceState.getString(LIFECYCLE_CALLABLE_TEXT_KEY));
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(LIFECYCLE_CALLABLE_TEXT_KEY,
                mLifecycleDisplay.getText().toString());
    }
