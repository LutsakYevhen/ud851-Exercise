...
public class MainActivity extends AppCompatActivity {
    ...
    static ArrayList<String> mLifecycleCallback = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = mLifecycleCallback.size() - 1; i >= 0; i--) {
            mLifecycleDisplay.append(mLifecycleCallback.get(i) + "\n");
        }
    ...
    protected void onStop() {
        ...
        mLifecycleCallback.add(ON_STOP);
    ...
    protected void onDestroy() {
        ...
        mLifecycleCallback.add(ON_DESTROY);
