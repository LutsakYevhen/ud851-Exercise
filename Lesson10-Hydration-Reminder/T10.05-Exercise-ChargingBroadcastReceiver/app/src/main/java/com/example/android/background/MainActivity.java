...
public class MainActivity extends AppCompatActivity implements
    ...
    private ChargingBroadcastReceiver mChargingBroadcast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChargingBroadcast = new ChargingBroadcastReceiver();
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingBroadcast, mChargingIntentFilter);
    }

    @Override
    protected void onPause() {
        super.onPause();
        unregisterReceiver(mChargingBroadcast);
    }
